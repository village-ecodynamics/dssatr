...
vepPolygon <- FedData::polygon_from_extent(raster::extent(672800,740000,4102000,4170000),
                                  proj4string="+proj=utm +datum=NAD83 +zone=12")

template <- vepPolygon
VEPN <- sp::spTransform(rgdal::readOGR("../DATA/","CMV",stringsAsFactors=F),sp::CRS("+proj=lcc +x_0=0 +y_0=0 +lon_0=-100 +lat_0=42.5 +lat_1=25 +lat_2=60 +ellps=WGS84"))
